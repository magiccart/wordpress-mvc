...
class DataObject implements \ArrayAccess
{
    ...
    public function getData($key = '', $index = null)
    {
        ...
        if ($index !== null) {
            if ($data === (array)$data) {
                ...
                $data = isset($data[$index]) ? $data[$index] : null;
            } elseif ($data instanceof \Magiccart\Core\DataObject) {
     ...
     * @param   array $args
     * @return  mixed
     * @throws \Magiccart\Core\Exception\LocalizedException
     */
    public function __call($method, $args)
    {
        ...
        $e = 'Invalid method ' . get_class($this) . '::' . $method;
    ...
    public function debug($data = null, &$objects = [])
    {
        ...
        foreach ($data as $key => $value) {
            ...
            } elseif ($value instanceof \Magiccart\Core\DataObject) {
